...
export function LegalPage({
  ...
  return (
    <main className={`legal-page${stickyHero ? " legal-page--sticky-hero" : ""}`}>
      <div className="legal-hero">
        ...
        <div className="legal-hero-content">
          ...
          <span className="legal-updated">
            <CalendarDays size={14} /> {dateLabel}: {updated}
          </span>
        </div>
      </div>
      ...
      <div className="legal-scroll">
        <div className="legal-layout">
          ...
          <article className="legal-article">
            {introduction && <div className="legal-section legal-section-body">{introduction}</div>}
            {sections.map((section) => (
        ...
        <footer className="legal-foot">
          <p>Questions about {contactLabel}? Reach us at</p>
