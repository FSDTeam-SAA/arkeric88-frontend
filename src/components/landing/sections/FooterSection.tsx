    ...
    <footer id="footer">
      <div className="footer-grid">
        ...
        <div>
          <h3>Contact Us</h3>
          {/* <a
            href="https://maps.google.com/?q=4140+Parker+Rd+Allentown+New+Mexico+31134"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a href="tel:+1 (830) 433-7323">+1 (830) 433-7323</a>
          <a href="mailto:hello@velaritravel.com">hello@velaritravel.com</a>
        </div>
        <div>
          <h3>Account</h3>
          <Link href="/login">Log In</Link>
          <Link href="/signup">Create Account</Link>
          <Link href="/account/personal-information">My Profile</Link>
        </div>
      </div>
